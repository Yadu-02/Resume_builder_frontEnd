    ...
    <div class="">
      ...
      <section id='bg-1'>
        <div className='row pt-5 text-dark'>
          ...
          <div className='col-12 col-md-4 box py-5 border rounded mt-5 text-center  bg-white '>
            <h4>Designed to get hired.</h4>
            <p>Your skills, your story, your next job - all in one.</p>
            <Link to={'/resume'}>
              <Button variant="contained">Create Your's</Button>
            </Link>
          </div>
          <div className='col-12 col-md-4'></div>
        </div>
        ...
        <div className="row p-5">
          ...
          <div className="col-12 col-md-6">
            <div className="row ">
              ...
              <div className="col-3">
                <img src="https://assets.livecareer.co.uk/blobimages/lcintl-lp/luk/images/grid/grid4.png" alt="" />
              </div>
            </div>
            <div className="row my-3"><div className="col-3">
                <img src="https://assets.livecareer.co.uk/blobimages/lcintl-lp/luk/images/grid/grid5.png" alt="" />
              </div>
              <div className="col-3">
                <img src="https://assets.livecareer.co.uk/blobimages/lcintl-lp/luk/images/grid/grid6.png" alt="" />
              </div>
              <div className="col-3">
                <img src="https://assets.livecareer.co.uk/blobimages/lcintl-lp/luk/images/grid/grid7.png" alt="" />
              </div>
              <div className="col-3">
                <img src="https://assets.livecareer.co.uk/blobimages/lcintl-lp/luk/images/grid/grid8.png" alt="" />
              </div></div>
            <div className="row "><div className="col-3">
                <img src="https://assets.livecareer.co.uk/blobimages/lcintl-lp/luk/images/grid/grid9.png" alt="" />
              </div>
              <div className="col-3">
                <img src="https://assets.livecareer.co.uk/blobimages/lcintl-lp/luk/images/grid/grid10.png" alt="" />
              </div>
              <div className="col-3">
                <img src="https://assets.livecareer.co.uk/blobimages/lcintl-lp/luk/images/grid/grid11.png" alt="" />
              </div>
              <div className="col-3">
                <img src="https://assets.livecareer.co.uk/blobimages/lcintl-lp/luk/images/grid/grid12.png" alt="" />
              </div></div>
          </div>
        </div>
      </section>
