      ...
      <AppBar position="static">
        <Toolbar>
          <IconButton
            ...
            sx={{ mr: 2 }}
          >
            <img class="" style={{width:"40px"}} src="https://is1-ssl.mzstatic.com/image/thumb/PurpleSource211/v4/7f/16/ec/7f16ecaa-afcb-54d9-005d-d8c046529473/Placeholder.mill/400x400bb-75.webp" alt="" />
          </IconButton>
          <div class="d-flex w-100 justify-content-between align-items-center ">
            <Typography variant="h6" class="fw-bolder" component="div" sx={{ flexGrow: 1 }}>
